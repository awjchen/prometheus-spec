    ...
    it "is adding new labels (for counter) while sampling" $ do
      ...
      dynamicCounter <-
        createCounterVector
          ...
          store
          Map.toList
      CounterVector.add dynamicCounter (M.singleton "label_name_1" "label value 1") 10
      CounterVector.add dynamicCounter (M.singleton "label_name_2" "label value 1") 10
      ...
      CounterVector.add dynamicCounter (M.singleton "label_name_2" "label value 1") 10
      CounterVector.add dynamicCounter (M.singleton "label_name_2" "label value 2") 10
      CounterVector.add dynamicCounter (M.singleton "label_name_3" "label value 1") 10
    ...
    it "is adding new lables (for gauge) while sampling" $ do
      ...
      dynamicGauge <-
        createGaugeVector
          ...
          store
          Map.toList
      GaugeVector.set dynamicGauge (M.singleton "label_name_1" "label value 1") 10
      GaugeVector.set dynamicGauge (M.singleton "label_name_2" "label value 1") 10
      ...
      GaugeVector.set dynamicGauge (M.singleton "label_name_2" "label value 1") 10
      GaugeVector.set dynamicGauge (M.singleton "label_name_2" "label value 2") 10
      GaugeVector.set dynamicGauge (M.singleton "label_name_3" "label value 1") 10
    ...
    it "is adding new lables (for histogram) while sampling" $ do
      ...
      dynamicHistogram <-
        createHistogramVector
          ...
          store
          Map.toList
      HistogramVector.observe dynamicHistogram (M.singleton "label_name_1" "label value 1") 10
      HistogramVector.observe dynamicHistogram (M.singleton "label_name_2" "label value 1") 10
      ...
      shouldBe
        ...
        \my_dynamic_histogram_bucket{le=\"1.0\",label_name_1=\"label value 1\"} 0\n\
        \my_dynamic_histogram_bucket{le=\"10.0\",label_name_1=\"label value 1\"} 1\n\
        \my_dynamic_histogram_bucket{le=\"100.0\",label_name_1=\"label value 1\"} 1\n\
        \my_dynamic_histogram_bucket{le=\"+Inf\",label_name_1=\"label value 1\"} 1\n\
      ...
      HistogramVector.observe dynamicHistogram (M.singleton "label_name_2" "label value 1") 100
      HistogramVector.observe dynamicHistogram (M.singleton "label_name_2" "label value 2") 100
      HistogramVector.observe dynamicHistogram (M.singleton "label_name_3" "label value 1") 100
